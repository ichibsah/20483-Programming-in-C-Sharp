...
namespace GradesPrototype.Data
{
    ...
    // DONE: Exercise 1: Task 1a: Create the User abstract class with the common functionality for Teachers and Students
    public abstract class User
    {
        // DONE: Exercise 1: Task 1b: Add the UserName property to the User class
        public string UserName { get; set; }
        //private string _password;
        // DONE: Exercise 1: Task 1c: Add the Password property to the User class
        ...
        // DONE: Exercise 1: Task 1d: Add the VerifyPassword method to the User class
    ...
    public class Student : User, IComparable<Student>
    {
        ...
        // DONE: Exercise 1: Task 2b: Remove the UserName property (now inherited from User)
        //public new string UserName { get; set; }

        // DONE: Exercise 1: Task 2c: Remove the Password property (now inherited from User)
        //private string _password = Guid.NewGuid().ToString(); // Generate a random password by default
        ...
        // DONE: Exercise 1: Task 2d: Remove the VerifyPassword method (now inherited from User)
        /*public bool VerifyPassword(string pass)
        {
            return (String.Compare(pass, _password) == 0);
        }*/
    ...
    // DONE: Exercise 1: Task 2e: Inherit from the User class
