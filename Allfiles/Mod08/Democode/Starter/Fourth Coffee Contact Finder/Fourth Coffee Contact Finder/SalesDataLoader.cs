...
// Done: 01: Bring the System.Net namespace into scope.
using System.Net;
...
namespace Fourth_Coffee_Contact_Finder
{
    ...
    {
        Uri _serviceUri;
        // Done: 02: Declare a global object to encapsulate an HTTP request.
        ...
        public SalesPerson GetPersonByEmail(string email)
        {
            ...
            // Done: 04: Configure the request to send JSON data.
        ...
        {
            // Done: 03: Instantiate the _request object.
        ...
        {
            // Done: 05: Write data to the request stream.
        ...
        {
            // Done: 06: Create an HttpWebResponse object.
